...
import com.example.vexeonline.adapter.XeLimousineAdapter;
...
public class LimousineActivity extends AppCompatActivity {

    private Toolbar toolbarXeLimousine;
    private ListView lvXeLimousine;
    private View footerView;

    private XeLimousineAdapter xeLimousineAdapter;
    ...
    private void loadMoreData() {
        ...
        lvXeLimousine.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        lvXeLimousine.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
    ...
    private void getData(int Page) {
        ...
        String url = Server.urlXeLimousine + String.valueOf(Page);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response != null && response.length() != 2) {
                    lvXeLimousine.removeFooterView(footerView);
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            xeLimousineAdapter.notifyDataSetChanged();
    ...
    private void actionToolbar() {
        setSupportActionBar(toolbarXeLimousine);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        toolbarXeLimousine.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void init() {
        toolbarXeLimousine = findViewById(R.id.toolbarXeLimousine);
        lvXeLimousine = findViewById(R.id.lvXeLimousine);

        sanphams = new ArrayList<>();
        xeLimousineAdapter = new XeLimousineAdapter(getApplicationContext(), sanphams);
        lvXeLimousine.setAdapter(xeLimousineAdapter);
    ...
    public class MHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    lvXeLimousine.addFooterView(footerView);
                    break;
                case 1:
                    getData(++page);
                    isLoading = false;
